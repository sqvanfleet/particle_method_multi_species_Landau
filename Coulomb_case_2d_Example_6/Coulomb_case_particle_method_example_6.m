...
% Initial Conditions
[f1_0,f2_0,example] = Example_6_coulumb_case_2d(vx1,vy1,vx2,vy2,m,n1,u1,u2,T);
% initial weights
t0 = 0; 
...
%     drawnow
    ...
    nn = sum(W1);
    rho = m(1)*nn; %mass
    m1 = (1/nn)*sum(W1.*Vx1); %momentum in Vx component   
    m2 = (1/nn)*sum(W1.*Vy1); %momentum in Vy component

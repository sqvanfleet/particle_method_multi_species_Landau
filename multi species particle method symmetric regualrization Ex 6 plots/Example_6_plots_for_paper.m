...
data_n_40 = load('multi_species_particle_2d_symmetric_n_40_Example_6_dv1_0.15_dv2_0.2_dt_0.01tmax5.mat');
data_n_45 = load('multi_species_particle_2d_symmetric_n_45_Example_6_dv1_0.13333_dv2_0.17778_dt_0.01tmax5.mat');
data_n_50 = load('multi_species_particle_2d_symmetric_n_50_Example_6_dv1_0.12_dv2_0.16_dt_0.01tmax5.mat');
data_n_55 = load('multi_species_particle_2d_symmetric_n_55_Example_6_dv1_0.10909_dv2_0.14545_dt_0.01tmax5.mat');
data_n_60 = load('multi_species_particle_2d_symmetric_n_60_Example_6_dv1_0.1_dv2_0.13333_dt_0.005tmax5.mat');
...
% hold on 
plot(error_list_s1_40(:,1),error_list_s1_40(:,4),'DisplayName',...
    ['n = ',num2str(n_40),' dt = ',num2str(dt_40)]);
hold on 
plot(error_list_s1_45(:,1),error_list_s1_45(:,4),'DisplayName',...
    ['n = ',num2str(n_45),' dt = ',num2str(dt_45)]);
hold on 
...
print(f,'Example_1b_ROC_species_1.pdf','-dpdf','-r0')
% exportgraphics(f,'Example 1b ROC species 1.eps')
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'Example_1b_ROC_species_2.pdf','-dpdf','-r0')
% exportgraphics(f,'Example 1b ROC species 2.eps')
...
exportgraphics(f,'Example 1b energy.eps')
...
set(hl,'Interpreter','latex')
f = gcf;
exportgraphics(f,'Example 1b entropy.eps')
...
%     +error_list_s2_40(:,6),'-*','MarkerIndices',round(linspace(1,Nt_40,5))...
%     ,'DisplayName',['$n = $ ',num2str(n_40),' $\Delta t =$ ',num2str(dt_40)]);
% hold on
% plot(error_list_s1_45(:,1),error_list_s1_45(:,6)...
%     +error_list_s2_45(:,6),'-*','MarkerIndices',round(linspace(1,Nt_40,5))...
%     ,'DisplayName',['$n = $ ',num2str(n_45),' $\Delta t =$ ',num2str(dt_45)]);
% hold on
% plot(error_list_s1_50(:,1),error_list_s1_50(:,6)...
%     +error_list_s2_50(:,6),'-*','MarkerIndices',round(linspace(1,Nt_40,5))...
%     ,'DisplayName',['$n = $ ',num2str(n_50),' $\Delta t =$ ',num2str(dt_50)]);
% hold on
% plot(error_list_s1_55(:,1),error_list_s1_55(:,6)...
%     +error_list_s2_55(:,6),'-*','MarkerIndices',round(linspace(1,Nt_40,5))...
%     ,'DisplayName',['$n = $ ',num2str(n_55),' $\Delta t =$ ',num2str(dt_55)]);
% hold on
plot(error_list_s1_60(:,1),error_list_s1_60(:,6)...
    +error_list_s2_60(:,6),'-x','MarkerIndices',round(linspace(1,Nt_40,5))...
    ,'DisplayName',['$n = $ ',num2str(n_60),' $\Delta t =$ ',num2str(dt_60)]);
% hold off
xlabel('$t$','Interpreter','latex')
...
% set(f,'Units','pixels')
% set(f,'Position',[440 378 560 420])
exportgraphics(f,'Example 1b Total Momentum v1 direction.eps')

%Total momentum plots
%y-direction
figure
% plot(error_list_s1_40(:,1),error_list_s1_40(:,7)...
%     +error_list_s2_40(:,7),'-*','MarkerIndices',round(linspace(1,Nt_40,5))...
%     ,'DisplayName',['$n = $ ',num2str(n_40),' $\Delta t =$ ',num2str(dt_40)]);
% hold on
% plot(error_list_s1_45(:,1),error_list_s1_45(:,7)...
%     +error_list_s2_45(:,7),'-*','MarkerIndices',round(linspace(1,Nt_40,5))...
%     ,'DisplayName',['$n = $ ',num2str(n_45),' $\Delta t =$ ',num2str(dt_45)]);
% hold on
% plot(error_list_s1_50(:,1),error_list_s1_50(:,7)...
%     +error_list_s2_50(:,7),'-*','MarkerIndices',round(linspace(1,Nt_40,5))...
%     ,'DisplayName',['$n = $ ',num2str(n_50),' $\Delta t =$ ',num2str(dt_50)]);
% hold on
% plot(error_list_s1_55(:,1),error_list_s1_55(:,7)...
%     +error_list_s2_55(:,7),'-*','MarkerIndices',round(linspace(1,Nt_40,5))...
%     ,'DisplayName',['$n = $ ',num2str(n_55),' $\Delta t =$ ',num2str(dt_55)]);
% hold on
plot(error_list_s1_60(:,1),error_list_s1_60(:,7)...
    +error_list_s2_60(:,7),'-x','MarkerIndices',round(linspace(1,Nt_40,5))...
    ,'DisplayName',['$n = $ ',num2str(n_60),' $\Delta t =$ ',num2str(dt_60)]);
% hold off
xlabel('$t$','Interpreter','latex')
ylabel('$P$','Interpreter','latex')
...
% set(f,'Units','pixels')
% set(f,'Position',[440 378 560 420])
exportgraphics(f,'Example 1b Total Momentum v2 direction.eps')

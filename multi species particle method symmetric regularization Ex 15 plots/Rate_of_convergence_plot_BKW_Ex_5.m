...
data_n_60 = load('multi_species_particle_2d_symmetric_n_60_Example_15_dv1_0.03_dv2_0.13333_dt_0.001tmax5.mat',myVars{:});
data_n_80 = load('multi_species_particle_2d_symmetric_n_80_Example_15_dv1_0.0225_dv2_0.1_dt_0.001tmax5.mat',myVars{:});
data_n_100 = load('multi_species_particle_2d_symmetric_n_100_Example_15_dv1_0.018_dv2_0.08_dt_0.001tmax5.mat',myVars{:});
data_n_120 = load('multi_species_particle_2d_symmetric_n_120_Example_15_dv1_0.015_dv2_0.066667_dt_0.001tmax5.mat',myVars{:});
...
%Rate of convergence plot both species 
figure
plot(-log(h_list_s1),-L2_roc_s1(2)*log(h_list_s1)-L2_roc_s1(1),'--b','DisplayName',['L2 roc = ',num2str(L2_roc_s1(2))])
hold on
plot(-log(h_list_s1),-L1_roc_s1(2)*log(h_list_s1)-L1_roc_s1(1),'--r','DisplayName',['L1 roc = ',num2str(L1_roc_s1(2))])
hold on
plot(-log(h_list_s1),-Linf_roc_s1(2)*log(h_list_s1)-Linf_roc_s1(1),'--g','DisplayName',['Linf roc = ',num2str(Linf_roc_s1(2))])
hold on
plot(-log(h_list_s2),-L2_roc_s2(2)*log(h_list_s2)-L2_roc_s2(1),'-.b','DisplayName',['L2 roc = ',num2str(L2_roc_s2(2))])
hold on
plot(-log(h_list_s2),-L1_roc_s2(2)*log(h_list_s2)-L1_roc_s2(1),'-.r','DisplayName',['L1 roc = ',num2str(L1_roc_s2(2))])
hold on
plot(-log(h_list_s2),-Linf_roc_s2(2)*log(h_list_s2)-Linf_roc_s2(1),'-.g','DisplayName',['Linf roc = ',num2str(Linf_roc_s2(2))])
plot(-log(h_list_s1),-2*log(h_list_s1)+1,'k','DisplayName','Reference Slope = 2')

...
% Example 18
[Vmax1,Vmax2,B1,beta,m,n1,example] = multi_species_example_18();
...
legend
title('$f_1(:,Nr/2)$','Interpreter','latex')
...
legend
title('$f_2(:,Nr/2)$','Interpreter','latex')
...
filename = ['multi_species_particle_2d_symmetric_parallel_n_',num2str(n),'_Example_',num2str(example),'_dv1_',num2str(dv1),'_dv2_',num2str(dv2),'_dt_',num2str(dt),'tmax',num2str(tmax),'.mat'];
save(filename)

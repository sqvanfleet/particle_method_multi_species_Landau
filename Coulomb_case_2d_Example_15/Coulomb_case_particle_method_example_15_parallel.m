...
% Initial Conditions
[f1_0,f2_0,example] = Example_15_coulumb_case_2d(vx1,vy1,vx2,vy2,m,n1,u1,u2,T);
% initial weights
t0 = 0; 
...
filename = ['multi_species_particle_2d_Coulomb_n_',num2str(n),'_Example_',num2str(example),'_gamma_',num2str(gamma),'_dv1_',num2str(dv1),'_dv2_',num2str(dv2),'_dt_',num2str(dt),'tmax',num2str(time),'.mat'];
save(filename)

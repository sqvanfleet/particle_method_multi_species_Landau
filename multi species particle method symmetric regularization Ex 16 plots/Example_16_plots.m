...
data_n_60 = load('multi_species_particle_2d_symmetric_n_60_Example_16_dv1_0.13333_dv2_0.13333_dt_0.001tmax5.mat',myVars{:});
data_n_80 = load('multi_species_particle_2d_symmetric_n_80_Example_16_dv1_0.1_dv2_0.1_dt_0.001tmax5.mat',myVars{:});
data_n_100 = load('multi_species_particle_2d_symmetric_n_100_Example_16_dv1_0.08_dv2_0.08_dt_0.001tmax5.mat',myVars{:});
data_n_120 = load('multi_species_particle_2d_symmetric_n_120_Example_16_dv1_0.066667_dv2_0.066667_dt_0.001tmax5.mat',myVars{:});
% data_n_150 = load('multi_species_particle_2d_symmetric_n_150_Example_7_dv1_0.026667_dv2_0.053333_dt_0.01tmax5.mat',myVars{:});
...
print(f,'Example_2b_L2_error_species_1.pdf','-dpdf','-r0')
% exportgraphics(f,'Example 2b L2 error species 1.eps','Resolution',300)
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'Example_2b_L2_error_species_2.pdf','-dpdf','-r0')
% exportgraphics(f,'Example 2b L2 error species 2.eps','Resolution',300)
...
hold on
plot(-log(h_list_s1),-2*log(h_list_s1)-2.5,'LineWidth',2,...
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'Example_2b_ROC_species_1.pdf','-dpdf','-r0')
% exportgraphics(f,'Example 2b ROC species 1.eps','Resolution',300)
...
hold on
plot(-log(h_list_s2),-2*log(h_list_s2)-1.7,'LineWidth',2,...
    'color','k','DisplayName','Reference Slope = 2')
%xlim([1.9,2.8])
ylim([2.0,4.5])
xlabel('$\log{h}$','Interpreter','latex')
...
pos = get(f,'Position');
set(f,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)])
print(f,'Example_2b_ROC_species_2.pdf','-dpdf','-r0')
% exportgraphics(f,'Example 2b ROC species 2.eps','Resolution',300)
...
figure
plot(error_list_s1_60(:,1),m(1)*error_list_s1_60(:,8)...
    +m(2)*error_list_s2_60(:,8),'DisplayName','n = 60');
% ylim([2.9,3.1])
xlabel('Time')
ylabel('Energy')
